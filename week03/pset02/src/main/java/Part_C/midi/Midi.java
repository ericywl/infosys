...
public class Midi {
     ...
     * @param instr:    instrument in Instrument enum.
     */
     ...
     *
     * @param note: first argument to pass to beginNote(int note, Instrument instr)
     */
     ...
     *
     * @param note: first argument to pass to endNote(int note, Instrument instr)
     */
