...
public class Sophomore implements Visitable {
    ...
    public Sophomore(String nm, String no) {
        this.name = nm;
        this.number = no;
    ...
    public Vector getCourseGrades () {return this.course_grades;}
    public void putGpa (double g) {this.gpa = g;}
